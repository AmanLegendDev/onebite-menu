  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8 text-black">
      <div className="max-w-lg mx-auto bg-white shadow-lg rounded-xl p-8" id="bill-area">
        ...
        {/* RESTAURANT HEADER */}
        <h1 className="text-2xl font-bold text-center">Restaurant Bill</h1>
        <p className="text-center text-gray-600 mb-5">Shimla, Himachal Pradesh</p>

        {/* ORDER INFO */}
        <p className="text-sm mb-1"><b>Order ID:</b> {order._id}</p>
        <p className="text-sm mb-1"><b>Table:</b> {order.table}</p>
        <p className="text-sm mb-4"><b>Date:</b> {new Date(order.createdAt).toLocaleString()}</p>
